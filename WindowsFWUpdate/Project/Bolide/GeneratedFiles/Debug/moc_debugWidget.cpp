...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_debugWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_debugWidget_t qt_meta_stringdata_debugWidget = {
    {
QT_MOC_LITERAL(0, 0, 11), // "debugWidget"
QT_MOC_LITERAL(1, 12, 19), // "slot_setCmdTemplate"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 20) // "slot_sendCmdTemplate"

    },
    "debugWidget\0slot_setCmdTemplate\0\0"
    "slot_sendCmdTemplate"
};
...
void debugWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        debugWidget *_t = static_cast<debugWidget *>(_o);
        switch (_id) {
        case 0: _t->slot_setCmdTemplate((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->slot_sendCmdTemplate(); break;
        default: ;
        }
    }
}
...
void *debugWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_debugWidget.stringdata))
