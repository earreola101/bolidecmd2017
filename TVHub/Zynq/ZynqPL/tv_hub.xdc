...
set_property PACKAGE_PIN L19 [get_ports UART_0_RX]

#NET JX2_LVDS_6_P    LOC = L19 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_6_P"
set_property IOSTANDARD LVCMOS33 [get_ports UART_0_TX]
set_property PACKAGE_PIN L20 [get_ports UART_0_TX]

#NET JX2_LVDS_8_N    LOC = M18 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_8_N"
set_property IOSTANDARD LVCMOS33 [get_ports UART_1_RX]
set_property PACKAGE_PIN M18 [get_ports UART_1_RX]

#NET JX2_LVDS_8_P    LOC = M17 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_8_P"
set_property IOSTANDARD LVCMOS33 [get_ports UART_1_TX]
set_property PACKAGE_PIN M17 [get_ports UART_1_TX]

#NET JX2_LVDS_10_N   LOC = L17 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_10_N"
set_property IOSTANDARD LVCMOS33 [get_ports UART_2_TX]
set_property PACKAGE_PIN L17 [get_ports UART_2_TX]

#NET JX2_LVDS_10_P   LOC = L16 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_10_P"
set_property IOSTANDARD LVCMOS33 [get_ports UART_2_RX]
set_property PACKAGE_PIN L16 [get_ports UART_2_RX]

#NET JX2_LVDS_7_N    LOC = M20 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_7_N"
set_property IOSTANDARD LVCMOS33 [get_ports STM32_BOOT0]
set_property PACKAGE_PIN M20 [get_ports STM32_BOOT0]

#NET JX2_LVDS_7_P    LOC = M19 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_7_P"
set_property IOSTANDARD LVCMOS33 [get_ports STM32_NRST_M]
set_property PACKAGE_PIN M19 [get_ports STM32_NRST_M]

##NET JX1_LVDS_1_P    LOC = T12 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_1_P"
#set_property IOSTANDARD LVCMOS33 [get_ports BUFFER_0_RX]
#set_property PACKAGE_PIN T12 [get_ports BUFFER_0_RX]

##NET JX1_SE_1        LOC = T19 | IOSTANDARD = LVCMOS18;  # "JX1_SE_1"
#set_property IOSTANDARD LVCMOS33 [get_ports BUFFER_0_TX]
#set_property PACKAGE_PIN T19 [get_ports BUFFER_0_TX]

##NET JX1_LVDS_8_P    LOC = T16 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_8_P"
#set_property IOSTANDARD LVCMOS33 [get_ports BUFFER_1_DIR]
#set_property PACKAGE_PIN T16 [get_ports BUFFER_1_DIR]

##NET JX1_LVDS_6_N    LOC = Y17 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_6_N"
#set_property IOSTANDARD LVCMOS33 [get_ports BUFFER_1_RX]
#set_property PACKAGE_PIN Y17 [get_ports BUFFER_1_RX]

##NET JX1_LVDS_6_P    LOC = Y16 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_6_P"
#set_property IOSTANDARD LVCMOS33 [get_ports BUFFER_1_TX]
#set_property PACKAGE_PIN Y16 [get_ports BUFFER_1_TX]

##NET JX1_LVDS_7_P    LOC = W14 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_7_P"
#set_property IOSTANDARD LVCMOS33 [get_ports BUFFER_2_DIR]
#set_property PACKAGE_PIN W14 [get_ports BUFFER_2_DIR]

##NET JX1_LVDS_5_N    LOC = R14 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_5_N"
#set_property IOSTANDARD LVCMOS33 [get_ports BUFFER_2_RX]
#set_property PACKAGE_PIN R14 [get_ports BUFFER_2_RX]

##NET JX1_LVDS_5_P    LOC = P14 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_5_P"
#set_property IOSTANDARD LVCMOS33 [get_ports BUFFER_2_TX]
#set_property PACKAGE_PIN P14 [get_ports BUFFER_2_TX]

#NET JX1_LVDS_14_P   LOC = T20 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_14_P"
set_property IOSTANDARD LVCMOS33 [get_ports BUFFER_3_DIR]
set_property PACKAGE_PIN T20 [get_ports BUFFER_3_DIR]

#NET JX1_LVDS_10_P   LOC = U14 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_10_P"
set_property IOSTANDARD LVCMOS33 [get_ports BUFFER_3_RX]
set_property PACKAGE_PIN U14 [get_ports BUFFER_3_RX]

#NET JX1_LVDS_10_N   LOC = U15 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_10_N"
set_property IOSTANDARD LVCMOS33 [get_ports BUFFER_3_TX]
set_property PACKAGE_PIN U15 [get_ports BUFFER_3_TX]

#NET JX1_LVDS_14_N   LOC = U20 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_14_N"
set_property IOSTANDARD LVCMOS33 [get_ports BUFFER_4_DIR]
set_property PACKAGE_PIN U20 [get_ports BUFFER_4_DIR]

#NET JX1_LVDS_16_P   LOC = Y18 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_16_P"
set_property IOSTANDARD LVCMOS33 [get_ports BUFFER_4_RX]
set_property PACKAGE_PIN Y18 [get_ports BUFFER_4_RX]

#NET JX1_LVDS_16_N   LOC = Y19 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_16_N"
set_property IOSTANDARD LVCMOS33 [get_ports BUFFER_4_TX]
set_property PACKAGE_PIN Y19 [get_ports BUFFER_4_TX]

#NET JX1_LVDS_9_P    LOC = V15 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_9_P"
set_property IOSTANDARD LVCMOS33 [get_ports I2S_0_SCK]
set_property PACKAGE_PIN V15 [get_ports I2S_0_SCK]

#NET JX1_LVDS_11_N   LOC = U19 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_11_N"
set_property IOSTANDARD LVCMOS33 [get_ports I2S_0_SDI]
set_property PACKAGE_PIN U19 [get_ports I2S_0_SDI]

#NET JX1_LVDS_11_P   LOC = U18 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_11_P"
set_property IOSTANDARD LVCMOS33 [get_ports {I2S_0_SDO[0]}]
set_property PACKAGE_PIN U18 [get_ports {I2S_0_SDO[0]}]

#NET JX1_LVDS_9_N    LOC = W15 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_9_N"
set_property IOSTANDARD LVCMOS33 [get_ports I2S_0_WS]
set_property PACKAGE_PIN W15 [get_ports I2S_0_WS]

#NET JX1_LVDS_4_N    LOC = T15 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_4_N"
set_property IOSTANDARD LVCMOS33 [get_ports AES3_2_TX]
set_property PACKAGE_PIN T15 [get_ports AES3_2_TX]

#NET JX1_LVDS_4_P    LOC = T14 | IOSTANDARD = LVCMOS18;  # "JX1_LVDS_4_P"
set_property IOSTANDARD LVCMOS33 [get_ports AES3_1_TX]
set_property PACKAGE_PIN T14 [get_ports AES3_1_TX]

#NET JX2_LVDS_12_P   LOC = H16 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_12_P"
set_property IOSTANDARD LVCMOS33 [get_ports PLL_MCLK]
set_property PACKAGE_PIN H16 [get_ports PLL_MCLK]

#NET JX2_LVDS_1_P    LOC = B19 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_1_P"
set_property PACKAGE_PIN B19 [get_ports I2S_USB_SCK]
set_property IOSTANDARD LVCMOS33 [get_ports I2S_USB_SCK]

#NET JX2_LVDS_1_N    LOC = A20 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_1_N"
set_property PACKAGE_PIN A20 [get_ports I2S_USB_WS]
set_property IOSTANDARD LVCMOS33 [get_ports I2S_USB_WS]

#NET JX2_LVDS_3_N    LOC = D20 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_3_N"
set_property PACKAGE_PIN D20 [get_ports I2S_USB_SD_IN]
set_property IOSTANDARD LVCMOS33 [get_ports I2S_USB_SD_IN]

#NET JX2_LVDS_3_P    LOC = D19 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_3_P"
set_property PACKAGE_PIN D19 [get_ports {I2S_USB_SD_OUT[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {I2S_USB_SD_OUT[0]}]

#NET JX2_LVDS_4_P    LOC = E18 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_4_P"
set_property PACKAGE_PIN E18 [get_ports PLL_SPI_CS]
set_property IOSTANDARD LVCMOS33 [get_ports PLL_SPI_CS]

#NET JX2_LVDS_2_N    LOC = D18 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_2_N"
set_property PACKAGE_PIN D18 [get_ports PLL_SPI_SCLK]
set_property IOSTANDARD LVCMOS33 [get_ports PLL_SPI_SCLK]

#NET JX2_LVDS_2_P    LOC = E17 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_2_P"
set_property PACKAGE_PIN E17 [get_ports PLL_SPI_MOSI]
set_property IOSTANDARD LVCMOS33 [get_ports PLL_SPI_MOSI]

#NET JX2_LVDS_0_N    LOC = B20 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_0_N"
set_property PACKAGE_PIN B20 [get_ports PLL_WCLK]
set_property IOSTANDARD LVCMOS33 [get_ports PLL_WCLK]

create_clock -period 61.035 -name PLL_MCLK [get_ports PLL_MCLK]

set_false_path -from [get_clocks -of_objects [get_pins tv_hub_design_i/clock_gen/clk_16_384M_to_20_48M/inst/mmcm_adv_inst/CLKOUT0]] -to [get_clocks clk_fpga_0]
set_false_path -from [get_clocks -of_objects [get_pins tv_hub_design_i/clock_gen/clk_phases/inst/plle2_adv_inst/CLKOUT0]] -to [get_clocks clk_fpga_0]
set_false_path -from [get_clocks -of_objects [get_pins tv_hub_design_i/clock_gen/clk_16_384M_to_20_48M/inst/mmcm_adv_inst/CLKOUT1]] -to [get_clocks clk_fpga_0]
set_false_path -from [get_clocks -of_objects [get_pins tv_hub_design_i/clock_gen/clk_phases/inst/plle2_adv_inst/CLKOUT0]] -to [get_clocks -of_objects [get_pins tv_hub_design_i/clock_gen/clk_16_384M_to_20_48M/inst/mmcm_adv_inst/CLKOUT0]]
set_false_path -from [get_clocks clk_fpga_0] -to [get_clocks -of_objects [get_pins tv_hub_design_i/clock_gen/clk_phases/inst/plle2_adv_inst/CLKOUT0]]
set_false_path -from [get_clocks clk_fpga_0] -to [get_clocks -of_objects [get_pins tv_hub_design_i/clock_gen/clk_16_384M_to_20_48M/inst/mmcm_adv_inst/CLKOUT1]]
set_false_path -from [get_clocks clk_fpga_0] -to [get_clocks -of_objects [get_pins tv_hub_design_i/clock_gen/clk_phases/inst/plle2_adv_inst/CLKOUT1]]
set_false_path -from [get_clocks clk_fpga_0] -to [get_clocks -of_objects [get_pins tv_hub_design_i/clock_gen/clk_phases/inst/plle2_adv_inst/CLKOUT2]]
set_false_path -from [get_clocks clk_fpga_0] -to [get_clocks -of_objects [get_pins tv_hub_design_i/clock_gen/clk_phases/inst/plle2_adv_inst/CLKOUT3]]



set_false_path -from [get_clocks clk_fpga_0] -to [get_clocks -of_objects [get_pins tv_hub_design_i/clock_gen/clk_16_384M_to_20_48M/inst/mmcm_adv_inst/CLKOUT0]]
