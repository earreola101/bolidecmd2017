...
file copy -force ../Build/tv_hub/tv_hub.runs/impl_1/tv_hub_design_wrapper.sysdef ../Build/fsbl_work/tv_hub.hdf
setws ../Build/fsbl_work


sdk createhw -name tv_hub_hw -hwspec ../Build/fsbl_work/tv_hub.hdf
sdk createapp -name fsbl -hwproject tv_hub_hw -proc ps7_cortexa9_0 -os standalone -lang C -app {Zynq FSBL}
