...
create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 $hier_name/BUS_MIC_DATA_BRAM_0
create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 $hier_name/BUS_MIC_DATA_BRAM_1
create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 $hier_name/BUS_HUB_DATA_BRAM_1
create_bd_intf_pin -mode Slave -vlnv bdsound.com:user:packet_handshake_port_rtl:1.0 $hier_name/MIC_PACKET_0
create_bd_intf_pin -mode Slave -vlnv bdsound.com:user:packet_handshake_port_rtl:1.0 $hier_name/MIC_PACKET_1
create_bd_intf_pin -mode Slave -vlnv bdsound.com:user:packet_handshake_port_rtl:1.0 $hier_name/HUB_PACKET_1
...
create_bd_pin -dir I $hier_name/hub_1_locked
create_bd_pin -dir I $hier_name/mic_0_locked
create_bd_pin -dir I $hier_name/mic_1_locked
...
set_property -dict [list \
						CONFIG.PORT_NUMBER {4} \
						CONFIG.PORT_1_TRUE_BRAM {true} \
						CONFIG.PORT_2_TRUE_BRAM {false} \
						CONFIG.PORT_3_TRUE_BRAM {false} \
						CONFIG.PORT_4_TRUE_BRAM {false} \
...
connect_bd_net 	[get_bd_pins $hier_name/hub_1_locked] \
				[get_bd_pins $hier_name/comm_manager/HUB_1_LOCKED]	
				
connect_bd_net 	[get_bd_pins $hier_name/mic_0_locked] \
				[get_bd_pins $hier_name/comm_manager/MIC_0_LOCKED]	
				
connect_bd_net 	[get_bd_pins $hier_name/mic_1_locked] \
				[get_bd_pins $hier_name/comm_manager/MIC_1_LOCKED]	
...
connect_bd_intf_net [get_bd_intf_pins $hier_name/HUB_PACKET_1] [get_bd_intf_pins $hier_name/packet_sender/packet2]
connect_bd_intf_net [get_bd_intf_pins $hier_name/MIC_PACKET_0] [get_bd_intf_pins $hier_name/packet_sender/packet3]
connect_bd_intf_net [get_bd_intf_pins $hier_name/MIC_PACKET_1] [get_bd_intf_pins $hier_name/packet_sender/packet4]
connect_bd_intf_net [get_bd_intf_pins $hier_name/BUS_HUB_DATA_BRAM_1] [get_bd_intf_pins $hier_name/packet_sender/packet2_bram_s]
connect_bd_intf_net [get_bd_intf_pins $hier_name/BUS_MIC_DATA_BRAM_0] [get_bd_intf_pins $hier_name/packet_sender/packet3_bram_s]
connect_bd_intf_net [get_bd_intf_pins $hier_name/BUS_MIC_DATA_BRAM_1] [get_bd_intf_pins $hier_name/packet_sender/packet4_bram_s]
