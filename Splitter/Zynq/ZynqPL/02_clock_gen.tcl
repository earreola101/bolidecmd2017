...
set_property -dict [list \
						...
						CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {20.480} \
						CONFIG.USE_RESET {false} \
...
connect_bd_net [get_bd_pins clock_gen/clk_16_384M_to_20_48M/clk_out1] [get_bd_pins clock_gen/proc_sys_reset_ext/slowest_sync_clk]
