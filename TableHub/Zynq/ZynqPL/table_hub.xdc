...
set_property PACKAGE_PIN D19 [get_ports {I2S_USB_SD_OUT}]
set_property IOSTANDARD LVCMOS33 [get_ports I2S_USB_SD_OUT]

set_false_path -from [get_clocks -of_objects [get_pins table_hub_design_i/clock_gen/clk_phases/inst/mmcm_adv_inst/CLKOUT0]] -to [get_clocks clk_fpga_0]
set_false_path -from [get_clocks clk_fpga_0] -to [get_clocks -of_objects [get_pins table_hub_design_i/clock_gen/clk_phases/inst/mmcm_adv_inst/CLKOUT0]]

set_false_path -from [get_clocks clk_fpga_0] -to [get_clocks -of_objects [get_pins table_hub_design_i/clock_gen/clk_phases/inst/mmcm_adv_inst/CLKOUT1]]
set_false_path -from [get_clocks clk_fpga_0] -to [get_clocks -of_objects [get_pins table_hub_design_i/clock_gen/clk_phases/inst/mmcm_adv_inst/CLKOUT2]]
set_false_path -from [get_clocks clk_fpga_0] -to [get_clocks -of_objects [get_pins table_hub_design_i/clock_gen/clk_phases/inst/mmcm_adv_inst/CLKOUT3]]

set_false_path -from [get_clocks clk_fpga_0] -to [get_clocks -of_objects [get_pins table_hub_design_i/clock_gen/clk_audio/inst/plle2_adv_inst/CLKOUT0]]
set_false_path -from [get_clocks -of_objects [get_pins table_hub_design_i/clock_gen/clk_audio/inst/plle2_adv_inst/CLKOUT0]] -to [get_clocks clk_fpga_0]
