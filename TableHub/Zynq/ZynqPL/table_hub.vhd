...
entity table_hub_design_wrapper is
  port (
    ...
    PLL_MCLK : out STD_LOGIC     
  );
end table_hub_design_wrapper;

architecture STRUCTURE of table_hub_design_wrapper is
  component table_hub_design is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
    ...
    BUS_MIC_RX : in STD_LOGIC;
    BUS_MIC_TX : out STD_LOGIC;
    BUS_HUB_0_DIR : out STD_LOGIC;
    BUS_HUB_0_RX : in STD_LOGIC;
    BUS_HUB_0_TX : out STD_LOGIC;
    BUS_HUB_1_DIR : out STD_LOGIC;
    BUS_HUB_1_RX : in STD_LOGIC;
    BUS_HUB_1_TX : out STD_LOGIC;
    I2S_0_SCK : out STD_LOGIC;
    I2S_0_SDI : in STD_LOGIC;
    I2S_0_SDO : out STD_LOGIC_VECTOR ( 0 to 0 );
    I2S_0_WS : out STD_LOGIC;
  ...
  end component table_hub_design;
  
  signal GPO : std_logic_vector(1 downto 0);
  
  signal BUS_MIC_RX : STD_LOGIC;
  signal BUS_MIC_TX : STD_LOGIC;
  signal BUS_HUB_0_DIR : STD_LOGIC;
  signal BUS_HUB_0_RX : STD_LOGIC;
  signal BUS_HUB_0_TX : STD_LOGIC;
  signal BUS_HUB_1_DIR : STD_LOGIC;
  signal BUS_HUB_1_RX : STD_LOGIC;
  signal BUS_HUB_1_TX : STD_LOGIC;
  
begin
table_hub_design_i: component table_hub_design
     port map (
      ...
      BUS_MIC_RX => BUS_MIC_RX,
      BUS_MIC_TX => BUS_MIC_TX,
      BUS_HUB_0_DIR => BUS_HUB_0_DIR,
      BUS_HUB_0_RX => BUS_HUB_0_RX,
      BUS_HUB_0_TX => BUS_HUB_0_TX,
      BUS_HUB_1_DIR => BUS_HUB_1_DIR,
      BUS_HUB_1_RX => BUS_HUB_1_RX,
      BUS_HUB_1_TX => BUS_HUB_1_TX,
      I2S_0_SCK => I2S_0_SCK,
      I2S_0_SDI => I2S_0_SDI,
      I2S_0_SDO => I2S_0_SDO,
      I2S_0_WS => I2S_0_WS,
    ...
    BUS_MIC_RX <= BUFFER_0_RX;
    BUFFER_0_TX <= BUS_MIC_TX;
    
    BUFFER_1_DIR <= BUS_HUB_0_DIR;
    BUFFER_2_DIR <= not BUS_HUB_0_DIR;
    BUFFER_1_TX <= BUS_HUB_0_TX;
    BUFFER_2_TX <= BUS_HUB_0_TX;
    BUS_HUB_0_RX <= BUFFER_1_RX when BUS_HUB_0_DIR = '0' else BUFFER_2_RX;
    
     
    BUFFER_3_DIR <= BUS_HUB_1_DIR;
    BUFFER_4_DIR <= not BUS_HUB_1_DIR;
    BUFFER_3_TX <= BUS_HUB_1_TX;
    BUFFER_4_TX <= BUS_HUB_1_TX;
    BUS_HUB_1_RX <= BUFFER_3_RX when BUS_HUB_1_DIR = '0' else BUFFER_4_RX;
