...
cp ZynqARM/Linux/additional-files/rootfs/sine_5000Hz_32000Hz_1ch.wav /media/$1/rootfs/
cp ZynqARM/Linux/additional-files/rootfs/stm32flash.elf /media/$1/rootfs/
cp ZynqARM/Linux/additional-files/rootfs/table_app_update.sh /media/$1/rootfs/
cp Build/app/table_hub_app /media/$1/rootfs/
chmod +x /media/$1/rootfs/bd_startup
chmod +x /media/$1/rootfs/stm32flash.elf 
chmod +x /media/$1/rootfs/table_app_update.sh
chmod +x /media/$1/rootfs/table_hub_app 
sync